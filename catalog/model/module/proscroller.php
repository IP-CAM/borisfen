...
class ModelModuleproscroller extends Model {
	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			$discount = $this->model_catalog_product->getMultiDiscountPrice($query->row['product_id'], $_price,$query->row['special'], $query->row['manufacturer_id']);
			if($discount){
			...
			$query->row['special_end'] = $special_end;
