...
// 	    ) {
// 	    	$this->document->addTs(TS_FOLDER . 'expand_debuger.ts');
// 	    }
// 	    /* Require ts for debuger */
	    
	    /* Subscription script */
	    $this->document->addScript(SCRIPT_FOLDER . 'news_subscription.js', true);
	    $this->document->addScript(SCRIPT_FOLDER . 'jquery/jquery.cookie.js', true);
	    /* Subscription script */
