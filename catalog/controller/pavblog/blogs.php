<?php
    ...
    class ControllerpavblogBlogs extends Controller {
        ...
        public function rss() {
            ...
            $output .= '<title><![CDATA[' . $this->language->get('blogs_latest_header_title') . ' - '
                       . $this->config->get('config_name') . ']]></title>';
        ...
        public function index() {
            ...
            if ($blogs) {
                ...
                if (isset($this->request->get['tag'])) {
                    ...
                    $this->data['heading_title'] = sprintf($this->data['heading_title'], "tag: "
