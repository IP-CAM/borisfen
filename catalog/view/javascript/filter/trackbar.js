...
$.fn.trackbar = function(op, id){
    ...
    leftHandler: 'catalog/view/theme/default/image/slide-handler-left.png',
    rightHandler: 'catalog/view/theme/default/image/slide-handler-right.png',
  ...
  // Methods
    ...
    this.leftHandler = hash.leftHandler || this.leftHandler;
        ...
        this.jq.html('<div id="disabled"></div><div' + (this.width ? ' style="width:'+this.width+'px;"' : '') + ' id="trackbar" onSelectStart="return false;">' +
                '<div id="left-block"><i class="slideHandler" id="left-begun" ondragstart="return false;"><i></i></i></div>' +
                '<div id="right-block"><i class="slideHandler" id="right-begun" ondragstart="return false;"><i>&nbsp;</i></i></div>' +
    ...
    this.addHandler (
			...
			'mouseup',
			function() {
				if (_this.onSet && _this.itWasMove && !lock && _this.moveState){
					_this.onSet();
					lock = true;
					setTimeout(function(){
						lock = false;
