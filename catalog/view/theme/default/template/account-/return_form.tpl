    ...
    <div id="content" class="col-xs-<?php echo $cols; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <div class="form-group required">
            <label class="col-xs-2 control-label"><?php echo $entry_reason; ?></label>
            <div class="col-xs-10">
          ...
          <div class="form-group required">
            <label class="col-xs-2 control-label"><?php echo $entry_opened; ?></label>
            <div class="col-xs-10">
          ...
          <div class="form-group">
            <label class="col-xs-2 control-label" for="input-comment"><?php echo $entry_fault_detail; ?></label>
            <div class="col-xs-10">
