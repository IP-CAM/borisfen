    ...
    <div class="col-xs-<?php echo $cols; ?>">
            ...
            <div class="checkout">
                <div id="checkout">
                    ...
                    <div class="panel-heading checkout-heading"><?php echo $text_checkout_option; ?></div>
                ...
                <?php if (!$logged) { ?>
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading checkout-heading"><span><?php echo $text_checkout_account; ?></span></div>
                    <div class="checkout-content"></div>
                </div>
                </div>
                <?php } else { ?>
                <div id="payment-address">
                  <div class="panel panel-default">
                    <div class="panel-heading checkout-heading"><span><?php echo $text_checkout_payment_address; ?></span></div>
                    <div class="checkout-content"></div>
                </div>
                </div>
                <?php } ?>
                ...
                <div id="shipping-address">
                  <div class="panel panel-default">
                    <div class="panel-heading checkout-heading"><?php echo $text_checkout_shipping_address; ?></div>
                    <div class="checkout-content"></div>
                </div>
                </div>
                <div id="shipping-method">
                  <div class="panel panel-default">
                    <div class="panel-heading checkout-heading"><?php echo $text_checkout_shipping_method; ?></div>
                    <div class="checkout-content"></div>
                </div>
                </div>
                <?php } ?>
                <div id="payment-method">
                  <div class="panel panel-default">
                    <div class="panel-heading checkout-heading"><?php echo $text_checkout_payment_method; ?></div>
                    <div class="checkout-content"></div>
                </div>
                </div>
                <div id="confirm">
                  <div class="panel panel-default">
                    <div class="panel-heading checkout-heading"><?php echo $text_checkout_confirm; ?></div>
                    <div class="checkout-content"></div>
                </div>
                </div>
            </div> <!-- checkout -->
...
$(document).on('click', '#button-account', function() {
    $.ajax({
        ...
        success: function(html) {
            ...
            $('#checkout .checkout-heading').append('<a class="pull-right"><span class="glyphicon glyphicon-chevron-down"></span></a>');
        },
        error: function(xhr, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
        }
                ...
                if (shipping_address) {
                    $.ajax({
                        ...
                        success: function(html) {
                            ...
                            $('#shipping-address .checkout-heading').append('<a class="pull-right"><span class="glyphicon glyphicon-chevron-down"></span></a>');                                  
                            $('#payment-address .checkout-heading').append('<a class="pull-right"><span class="glyphicon glyphicon-chevron-down"></span></a>');   
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#shipping-method .checkout-heading').append('<a class="pull-right"><span class="glyphicon glyphicon-chevron-down"></span></a>');   
                    },
                    error: function(xhr, ajaxOptions, thrownError) {
                        alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
                    }
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#payment-method .checkout-heading').append('<a class="pull-right"><span class="glyphicon glyphicon-chevron-down"></span></a>');    
                    },
                    error: function(xhr, ajaxOptions, thrownError) {
                        alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
                    }
