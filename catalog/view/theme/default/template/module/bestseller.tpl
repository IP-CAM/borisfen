...
<div class="box special">   
    ...
    <div id="scroller_bestseller" class="scroller product-grid">
      <ul class="row jcarousel-skin-opencart scroller" style="padding: 0; list-style: none;">
        <?php foreach ($products as $product) { ?>
		<li <?php if (isset($products) && (count($products) <= 4)) { ?>class="col-xs-3" <?php } ?>style="height: 334px; margin-bottom: 30px;">
...
<?php if (isset($products) && (count($products) > 4)) { ?>
<script type="text/javascript"><!--
    $('#scroller_bestseller ul').jcarousel({
        vertical: false,
        visible: 4,
        scroll: 1,
        animation: 1000
