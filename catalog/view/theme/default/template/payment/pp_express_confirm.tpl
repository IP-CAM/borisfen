...
<?php if ($attention) { ?>
    <div class="alert alert-danger"><?php echo $attention; ?></div>
<?php } ?>
        ...
        <div class="cart-discounts">
            ...
            <div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input class="form-control"  type="hidden" name="next" value="voucher" />
                    &nbsp;
                    <input class="form-control"  type="submit" value="<?php echo $button_voucher; ?>" class="button" />
                </form>
            </div>
            <div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input class="form-control"  type="hidden" name="next" value="reward" />
                    &nbsp;
                    <input class="form-control"  type="submit" value="<?php echo $button_reward; ?>" class="btn  btn-primary" />
                </form>
            </div>
        </div>
    <?php } ?>
