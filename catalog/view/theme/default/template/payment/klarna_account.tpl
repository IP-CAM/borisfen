    ...
    <table class="radio">
      ...
      <tr class="highlight">
        <td><?php if (!isset($code)) { ?>
          ...
          <input class="form-control"  type="radio" name="code" value="<?php echo $payment_option['code']; ?>" id="plan-id<?php echo $payment_option['code']; ?>" checked="checked" />
          <?php } else { ?>
          <input class="form-control"  type="radio" name="code" value="<?php echo $payment_option['code']; ?>" id="plan-id<?php echo $payment_option['code']; ?>" />
          <?php } ?></td>
  ...
  <div class="content">
    <table class="form">
      ...
      <tr>
        ...
        <td><input class="form-control"  type="radio" name="gender" value="1" id="male" />
          <label for="male"><?php echo $text_male; ?></label>
          <input class="form-control"  type="radio" name="gender" value="0" id="female" />
      ...
      <tr>
        <td colspan="2"><input class="form-control"  type="checkbox" name="deu_terms" value="1" />
