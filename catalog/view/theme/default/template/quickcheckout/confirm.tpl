        ...
        <div id="<?php echo $field['id']; ?>_input" class="box box-border sort-item form-group <?php echo $field['id']; ?> <?php echo ($field['class'])? $field['class'] : ''; ?>" data-sort="<?php echo $field['sort_order']; ?>">
          ...
          <div class="box-content">
            ...
            <div id="<?php echo $field['id']; ?>_input" class="textarea-input sort-item form-group <?php echo (!$field['display'])? 'hide' : ''; ?> <?php echo ($field['class'])? $field['class'] : ''; ?>" data-sort="<?php echo $field['sort_order']; ?>">
              <label for="confirm_<?php echo $field['id']; ?>"> <span class="required <?php echo (!isset($field['require']) ||  !$field['require']) ? 'hide' : ''; ?>">*</span> <span class="text"><?php echo $field['title']; ?></span> </label>
              <textarea class="form-control" name="confirm[<?php echo $field['id']; ?>]" id="confirm_<?php echo $field['id']; ?>" data-require="<?php echo (isset($field['require']) && $field['require']) ? 'require' : ''; ?>" data-refresh="<?php echo ($field['refresh']) ? $field['refresh'] : 0; ?>"><?php echo isset($field['value'])? $field['value'] : ''; ?></textarea>
            </div>
            <?php
            break;
            default:
