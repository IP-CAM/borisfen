...
$_['column_price']	=	'Цена за 1 единицу';
...
$_['text_recurring_item']	=	'Повторяющееся наименование';
$_['text_payment_profile']	=	'График оплаты';
$_['text_trial_description']	=	'%s каждый %d %s(s) для %d платежей тогда';
$_['text_payment_description']	=	'%s каждый %d %s(s) для %d платежей тогда';
$_['text_payment_until_canceled_description']	=	'%s каждый %d %s(s) до отмены';
$_['text_day']	=	'День';
$_['text_week']	=	'Неделя';
$_['text_semi_month']	=	'Полмесяца';
$_['text_month']	=	'Месяц';
$_['text_year']	=	'Год';
$_['error_profile_required']	=	'Пожалуйста, выберите график платежей!';
$_['text_trial']	=	'%s каждый %d %s(s) для %d платежей тогда';
