...
$_['decimal_point']	=	'.';
$_['thousand_point'] =	'';
$_['text_items']	=	'<span class="priceItems"><i>В корзине<br> товаров<span class="countItems">%s</span></i> <b>На сумму: <span>%s</span></b></span>';
$_['button_jv_quick_order']	=	'Быстрая покупка';
$_['text_home']	=	'Главная';
$_['text_yes']	=	'Да';
$_['text_no']	=	'Нет';
$_['yes']	=	'Да';
...
$_['text_sms_neworder_client']	=	'Ваш заказ добавлен и поступит в обработку. Номер заказа: %s';
$_['text_sms_neworder_administrator']	=	'Вам поступил новый заказ #%s';
$_['button_add_address']	=	'Добавить адрес';
$_['button_back']	=	'Назад';
$_['button_continue']	=	'Продолжить';
$_['button_cart']	=	'Купить сейчас';
$_['button_in_cart']	=	'Добавлено';
$_['button_compare']	=	'В сравнение';
$_['button_wishlist']	=	'В cписок желаемого';
...
$_['button_button_shopping']	=	'Продолжить покупки';
$_['button_cancel']	=	'Отмена товара';
