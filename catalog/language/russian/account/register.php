...
$_['text_account_already'] = 'Если Вы уже зарегистрированы, перейдите на страницу <a class="ajaxPage" href="/index.php?route=account/login/ajax2login
">входа в систему</a>.';
...
$_['text_agree']           = 'Я прочитал <a class="ajaxPage" href="%s" alt="%s"><b>%s</b></a> и согласен с условиями';
