...
class Pagination {
	...
	public function render() {
		...
		if ($page > 1) {
			$output .= ' <a href="' . str_replace('{page}', 1, $this->url) . '" rel="first">' . $this->text_first . '</a> <a href="' . str_replace('{page}', $page - 1, $this->url) . '" rel="prev">' . $this->text_prev . '</a> ';
		}
		...
		if ($page < $num_pages) {
			$output .= ' <a href="' . str_replace('{page}', $page + 1, $this->url) . '" rel="next">' . $this->text_next . '</a> <a href="' . str_replace('{page}', $num_pages, $this->url) . '"  rel="last">' . $this->text_last . '</a> ';
		}
