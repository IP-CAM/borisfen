...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		} elseif (isset($store_info['config_sms_notifications_admin'])) {
			$this->data['config_sms_notifications_admin'] = $store_info['config_sms_notifications_admin'];
		} else {
		...
		} elseif (isset($store_info['config_sms_notifications_text_customer'])) {
			$this->data['config_sms_notifications_text_customer'] = $store_info['config_sms_notifications_text_customer'];
		} else {
		...
		} elseif (isset($store_info['config_sms_notifications_text_admin'])) {
			$this->data['config_sms_notifications_text_admin'] = $store_info['config_sms_notifications_text_admin'];
		} else {
		...
		// Whole price from quantity
		if (isset($this->request->post['config_whole_sale_price_price'])) {
			$this->data['config_whole_sale_price_price'] = $this->request->post['config_whole_sale_price_price'];
		} elseif($this->config->get('config_whole_sale_price_price')) {
			$this->data['config_whole_sale_price_price'] = $this->config->get('config_whole_sale_price_price');		
		} else {
		    $this->data['config_whole_sale_price_price'] = 0;
		}                
		// Use bonus system
