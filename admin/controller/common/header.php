...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->document->addStyle('/catalog/view/theme/default/stylesheet/jquery.ui.datepicker.css');
...
//new order by today 
			...
			$total_order_data = array('filter_date_added' => date('Y-m-d')); 
...
//return 
            ...
            $total_return_data = array('filter_date_added' => date('Y-m-d'));
 
 
            $this->data['total_new_return'] = $this->model_sale_return->getTotalReturns($total_return_data); 
 //stock
            $this->load->model('catalog/product'); $total_product_data = array('filter_quantity' => '0'); 
