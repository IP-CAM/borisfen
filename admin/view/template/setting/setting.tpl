          ...
          <div class="tab-content">
			...
			<div class="btn-group" data-toggle="buttons">
	            ...
	            <fieldset>
	              ...
	              <div class="form-group">
	                <label class="col-xs-2 control-label"><?php echo $entry_config_sms_notifications_admin; ?></label>
	                <div class="col-xs-10">
	                    <div class="btn-group" data-toggle="buttons">
	                        <label class="btn btn-primary<?php if ($config_sms_notifications_admin == 1) { ?> active<?php } ?>">
	                            <i class="fa fa-check"></i> <input type="radio" name="config_sms_notifications_admin" value="1" <?php if ($config_sms_notifications_admin == 1) { ?>checked="checked"<?php } ?>> <?php echo $text_yes; ?>
	                        </label>
	                        <label class="btn btn-primary<?php if ($config_sms_notifications_admin == 0) { ?> active<?php } ?>">
	                            <i class="fa fa-times"></i> <input type="radio" name="config_sms_notifications_admin" value="0" <?php if ($config_sms_notifications_admin == 0) { ?>checked="checked"<?php } ?>> <?php echo $text_no; ?>
	                        </label>
	                    </div>
	                </div>
	              </div>
	              ...
	              <div class="form-group">
	                  ...
	                  <div class="col-xs-10">
	                    <div class="row">
	                      <div class="col-xs-6">
	                        <input type="text" name="config_sms_notifications_text_customer" value="<?php echo $config_sms_notifications_text_customer; ?>" class="form-control" />
	                      </div>
	                    </div>
	                  </div>
	              </div>
	              <div class="form-group">
	                  ...
	                  <div class="col-xs-10">
	                    <div class="row">
	                      <div class="col-xs-6">
	                        <input type="text" name="config_sms_notifications_text_admin" value="<?php echo $config_sms_notifications_text_admin; ?>" class="form-control" />
	                      </div>
	                    </div>
	                  </div>
	              </div>
			...
			<div class="btn-group" data-toggle="buttons">
	            ...
	            <fieldset>
	              ...
	              <div class="form-group">
	                <label for="input-config_whole_sale_price_price" class="col-xs-2 control-label">Оптовая цена от (сумма)</label>
	                <div class="col-xs-10">
	                    <input type="text" name="config_whole_sale_price_price" value="<?php echo $config_whole_sale_price_price; ?>" id="input-config_whole_sale_price_price" class="form-control" />
	                </div>
	              </div>  
