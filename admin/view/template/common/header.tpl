  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav navbar-right">
      	<li><a href="<?php echo $clear_cache; ?>"><i class="fa fa-minus-circle fa-lg"></i> <?php echo $text_clear_cache; ?></a></li>
        <li class="dropdown">
        <a data-toggle="dropdown"><span class="label label-danger pull-right"><?php echo $total_notification; ?></span><i class="fa fa-bell fa-lg"></i> </a> 
		...
		<li><a href="<?php echo $order; ?>&filter_order_status_id=<?php print $config_order_status_id;?>"><?php echo $text_pending_order; ?><span class="label pull-right<?php echo ($total_pending_order == '0' ? ' label-warning' : ' label-danger'); ?>"><?php echo $total_pending_order; ?></span></a></li>
		<?php endif; ?> 
		...
		<li class="divider" style="width:100%;min-width:220px"></li> <li><a href="<?php echo $product; ?>&filter_quantity=0"><?php echo $text_stockout; ?><span class="label pull-right<?php echo ($total_stockout == '0' ? ' label-info' : ' label-danger'); ?>"><?php echo $total_stockout; ?></span></a></li>
		<?php endif; ?>
        ...
        <li class="dropdown ">
            ...
            <ul class="dropdown-menu">
			  <li><a href="<?php echo $profile_user; ?>"><?php echo $logged; ?> <i class="fa fa-edit"></i></a></li>
			</ul>
        </li>
        <?php if($this->user->hasPermission('access','setting/store')): ?>
        <li><a href="<?php echo $setting; ?>"><i class="fa fa-cog fa-lg"> </i> <?php echo $text_setting; ?></a></li>
        <?php endif; ?>    
		...
		<?php } else { ?>
        <li><a href="<?php echo $store; ?>" target="_blank"> <i class="fa fa-shopping-cart fa-lg"></i> <?php echo $text_front; ?></a></li>
        <?php } ?>
        <li><a href="<?php echo $logout; ?>"><i class="fa fa-power-off fa-lg"></i> <?php echo $text_logout; ?></a></li>	        
	</ul> 
    </div>
    <?php } ?>
  </div>
    ...
    <div class="collapse navbar-collapse navbar-ex2-collapse">
      <ul class="nav navbar-nav">
        ...
        <li id="catalog" class="dropdown"><a data-toggle="dropdown"><?php echo $text_catalog; ?> </a>
          <ul class="dropdown-menu">
            <?php if($this->user->hasPermission('access', 'module/faq')){?>
            <li><a href="<?php print $this->url->link('module/faq/listing', 'token=' . $this->session->data['token']); ?>">FAQ - Отзывы</a></li>
            <?php }?>
            
            <?php if($this->user->hasPermission('access', 'module/faq_testimonial')){?>
            <li><a href="<?php print $this->url->link('module/faq_testimonial/listing', 'token=' . $this->session->data['token']); ?>">FAQ - Вопрос-ответ</a></li>
            <?php }?>
