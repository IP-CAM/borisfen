			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab-general">
						...
						<!-- FIELD WHOLE_SALE PRICE -->
						<?php if(false && $this->config->get('config_whole_sale_price')) { ?>
						<div class="form-group required col-xs-2">
						...
						<div class="form-group required col-xs-2">
							<!-- FIELD MODEL -->
							<label class="col-xs-12 control-label" for="input-model">Tovar№</label>
							<div class="col-xs-12">
								<input type="text" name="sku" value="<?php echo $sku; ?>" id="input-model" class="form-control" />
							</div>
							<!-- FIELD MODEL -->
						</div>
						<!-- FIELD MANUFACTURER -->
							...
							<div class="tab-pane" id="obshee">
								...
								<div class="tab-content">
									...
									<div class="tab-pane <?php if(!$l) { print 'active';} ?>" id="language-second-general<?php echo $language['language_id']; ?>">
										...
										<!-- FIELD TAGS -->
										<div class="form-group">
											<label class="col-xs-2 control-label" for="input-tags<?php echo $language['language_id']; ?>">Метки товара</label>
											<div class="col-xs-10">
												<input class="form-control width100" type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" id="input-tags<?php echo $language['language_id']; ?>" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>">
											</div>
										</div>
										<!-- FIELD TAGS -->
									</div>
														...
														<tbody>
															...
															<tr id="option-value-row<?php echo $option_value_row; ?>">
																<td class="text-left">
																	...
																	<input type="radio" name="default_option_value_id" <?php echo $product_option_value['is_default'] ? 'checked="checked"' : ''; ?> value="<?php echo $product_option_value['product_option_value_id']; ?>"/>По умолчанию
