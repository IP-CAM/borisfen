									...
									<tr>
										...
										<tr style="display:none;">
											...
											<tr>
												...
												<td>
													<input type="date" class="form-control" name="pavblog_blog[created]" value="<?php echo $blog['created'];?>" class="date">
												</td>
											</tr>
											<tr>
												<td>Дата события: </td>
												<td>
													<input type="date" class="form-control" name="pavblog_blog[date_event]" value="<?php echo $blog['date_event'];?>" class="date datepicker" data-date-format="YYYY-MM-DD">
												</td>
											</tr>
											<tr>
