...
if (
    (
        (
            ...
            (
                $_SERVER['REMOTE_ADDR'] == '37.57.71.199' ||
                $_SERVER['REMOTE_ADDR'] == '109.86.239.146' ||
                $_SERVER['REMOTE_ADDR'] == '127.0.0.1' ||
                $_SERVER['REMOTE_ADDR'] == '69.69.69.50' ||
                $_SERVER['REMOTE_ADDR'] == '69.69.69.112'
            )
        ) || (
            isset($_SERVER['HTTP_X_REAL_IP']) &&
            (
                $_SERVER['HTTP_X_REAL_IP'] == '37.57.71.199' ||
                $_SERVER['HTTP_X_REAL_IP'] == '109.86.239.146' ||
                $_SERVER['HTTP_X_REAL_IP'] == '127.0.0.1' ||
                $_SERVER['HTTP_X_REAL_IP'] == '69.69.69.50' ||
                $_SERVER['HTTP_X_REAL_IP'] == '69.69.69.112'
            )
        )
    ) && !$request->isXhr()
) {
